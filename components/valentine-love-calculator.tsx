...
//             <h2 className="text-3xl font-bold text-red-600 mb-2">Love Calculator</h2>
//             <p className="text-pink-600">Find your Valentine's match!</p>
//           </div>

//           <div className="space-y-4">
//             <div className="space-y-2">
//               <label className="block text-lg font-medium text-red-600">Your Name</label>
//               <Input
//                 type="text"
...
//             <div className="space-y-2">
//               <label className="block text-lg font-medium text-red-600">Your Valentine's Name</label>
//               <Input
//                 type="text"
